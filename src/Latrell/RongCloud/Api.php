...
class Api
{
     ...
     * @return json|xml
     */
    public function messagePrivatePublish($fromUserId, $toUserId, $objectName, $content, $isIncludeSender = 1, $isCounted = 1, $isPersisted = 1, $pushContent = '', $pushData = '', $count = NULL, $verifyBlacklist = 0)
    {
        try {
            if (empty($fromUserId))
